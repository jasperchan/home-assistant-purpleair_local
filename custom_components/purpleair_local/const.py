...
from homeassistant.const import UnitOfTemperature, SIGNAL_STRENGTH_DECIBELS_MILLIWATT, UnitOfPressure, PERCENTAGE, Platform
...
SENSORS_MAP = {
    'pm2_5_aqi_a_raw':         {'key': 'pm2_5_aqi_raw',    'uom': Platform.AIR_QUALITY, 'icon': 'mdi:blur-linear'},
    'pm2_5_aqi_b_raw':         {'key': 'pm2_5_aqi_b_raw',  'uom': Platform.AIR_QUALITY, 'icon': 'mdi:blur-linear'},
    'pm2_5_atm_confidence':    {'key': 'pm2_5_atm_conf',   'uom': None,             'icon': 'mdi:seal'},
    'particulate_matter_0_1':  {'key': 'pm1_0_atm',        'uom': Platform.AIR_QUALITY, 'icon': 'mdi:blur'},
    'particulate_matter_2_5':  {'key': 'pm2_5_atm',        'uom': Platform.AIR_QUALITY, 'icon': 'mdi:blur'},
